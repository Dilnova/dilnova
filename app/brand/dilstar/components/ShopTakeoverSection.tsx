...
const SCENES: SceneData[] = [
  ...
  },
  {
    ...
    departmentTitle: "04 \u2014 Advisory & Technical Cultivation Services",
    description:
      "Practical technical advice and coconut cultivation guidance from people who know the land.",
    badges: [
      "Technical consultation",
      "Coconut cultivation advice",
      "Planting & maintenance guidance",
      "On-site support",
    ],
    // [PLACEHOLDER: replace with real services photo - advisor speaking with customer, or hands examining sapling/equipment in DILSTAR_MEDIA.services]
