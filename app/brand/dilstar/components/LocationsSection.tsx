          ...
          {shops.map((shop, idx) => (
            ...
            >
              <div className="space-y-5">
                ...
                <div className="relative h-40 w-full overflow-hidden bg-zinc-950 rounded-lg border border-zinc-850">
                  <Image
                    src={shop.thumb.src}
                    alt={shop.thumb.alt}
                    fill
                ...
                <div>
                  ...
                  <h3 className="text-xl font-bold text-white tracking-tight mt-1">{shop.name}</h3>
                </div>
              ...
              <div className="pt-4">
                <a
                  ...
                  className="group inline-flex items-center gap-2 text-xs font-semibold text-white hover:text-teal-300 transition-colors uppercase tracking-wider font-mono"
                >
                  <span>Get directions</span>
                  <ExternalLink className="w-3.5 h-3.5 text-zinc-500 group-hover:text-teal-300 transition-colors" />
                </a>
              </div>
            </ScrollReveal>
          ))}
