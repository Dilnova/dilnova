/**
 * Media assets & placeholder configuration for Dilstar brand page.
 *
 * [PLACEHOLDER: replace with real shop photos and videos when available]
 * Updating the URLs below will automatically update the images across all components
 * without altering any layout or animation code.
 */

export const DILSTAR_MEDIA = {
  // Hero background poster (dark, moody, workshop/hardware theme)
  hero: {
    // [PLACEHOLDER: replace with real workshop / store video or high-res photo]
    posterSrc:
  ...
  locations: {
    hardwareThumb: {
      // [PLACEHOLDER: replace with real hardware storefront photo]
      src: "https://images.unsplash.com/photo-1513836279014-a89f7a76ae86?auto=format&fit=crop&w=600&q=80",
      alt: "Dilstar Hardware storefront in Ambalantota",
    },
    nurseryThumb: {
      // [PLACEHOLDER: replace with real nursery storefront photo]
      src: "https://images.unsplash.com/photo-1585320806297-9794b3e4eeae?auto=format&fit=crop&w=600&q=80",
      alt: "Dilstar Nursery green plant nursery in Ambalantota",
    },
    techThumb: {
