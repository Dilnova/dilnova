...
export default function FeaturedSeriesList({ seriesList, products }: FeaturedSeriesProps) {
  // If flat products array is provided, render a single unified grid
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="pt-6 text-center">
          <Link
            href="/products"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-zinc-900 dark:bg-zinc-800 hover:bg-zinc-800 dark:hover:bg-zinc-700 text-white font-bold text-xs sm:text-sm transition-all duration-200 shadow-sm"
          >
  ...
  // Fallback if no products or seriesList
