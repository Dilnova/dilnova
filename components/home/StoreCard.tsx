...
const themeMap = {
  hardware: {
    ...
    button: 'bg-amber-100 dark:bg-amber-950 text-amber-700 dark:text-amber-300 hover:bg-amber-200 dark:hover:bg-amber-900',
    icon: Wrench,
  },
  nursery: {
    color: 'emerald',
    ...
    button: 'bg-emerald-100 dark:bg-emerald-950 text-emerald-700 dark:text-emerald-300 hover:bg-emerald-200 dark:hover:bg-emerald-900',
    icon: Leaf,
  },
  tech: {
    color: 'indigo',
    ...
    button: 'bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900',
    icon: Cpu,
  },
  services: {
    color: 'teal',
    ...
    button: 'bg-teal-100 dark:bg-teal-950 text-teal-700 dark:text-teal-300 hover:bg-teal-200 dark:hover:bg-teal-900',
    icon: Users,
  }
};
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest ${theme.bg} ${theme.text}`}>
          {category}
        </span>
