...
export const simulatedOrders = pgTable(
  ...
  (t) => [
    ...
    index("idx_simulated_orders_tracking").on(t.trackingNumber),
  ],
);
...
export const simulatedOrderItems = pgTable(
  "simulated_order_items",
  {
    ...
    itemShippingAmount: integer("item_shipping_amount").default(0).notNull(),
    itemCarrier: text("item_carrier"),
    itemTrackingNumber: text("item_tracking_number"),
  },
  (t) => [
