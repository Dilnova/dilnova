...
export const categories = pgTable(
  ...
  (t) => [index("idx_categories_parent").on(t.parentId), index("idx_categories_slug").on(t.slug)],
);
...
export const products = pgTable(
  "products",
  {
    ...
    hsCode: text("hs_code"),
    shippingClass: text("shipping_class").default("standard").notNull(),
...
export const questions = pgTable(
  ...
  (t) => [index("idx_questions_product_id").on(t.productId)],
);
