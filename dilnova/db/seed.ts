...
async function main() {
  ...
  if (clerkSecretKey) {
    try {
      ...
      console.log(`Mapped organization IDs: Hardware (${hardwareOrgId}), Nursery (${nurseryOrgId}), Tech (${techOrgId}), Services (${servicesOrgId})`);
    } catch (e) {
  ...
  await db.insert(schema.products).values([
    // Hardware
    {
      ...
      type: 'product',
      description: 'Brushless cordless drill with variable speeds and high torque. Durable for contractor usage.',
      price: 8999, // $89.99
    ...
    // Plants
    {
      ...
      type: 'product',
      description: 'Stunning indoor plant with split green leaves. Easy to care for and perfect for living rooms.',
      price: 2999, // $29.99
    ...
    // Tech
    {
      ...
      type: 'product',
      description: 'AMD Ryzen 9, 64GB DDR5 RAM, 2TB NVMe SSD, RTX 4500 GPU. Designed for deep learning and heavy builds.',
    ...
    // Expert Services
    {
      ...
      type: 'service',
      description: '1-hour call or site visit with a master botanist to plan your indoor or outdoor garden layout.',
      price: 7500, // $75.00
    ...
    },
    {
      ...
      type: 'service',
      description: 'Full automated sprinkler layout setup linked to IoT gateway with remote weather tracking.',
      price: 15000, // $150.00
