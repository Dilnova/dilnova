...
export default function ProductImageZoom({ imageUrl, alt }: ProductImageZoomProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`absolute bottom-3 right-3 px-2.5 py-1.5 rounded-lg bg-zinc-900/80 backdrop-blur-md text-white text-[10px] font-mono tracking-wider flex items-center gap-1.5 transition-all duration-300 pointer-events-none select-none border border-white/10 ${
