...
describe('isVideoUrl', () => {
  it('should identify Cloudinary video URLs', () => {
    expect(isVideoUrl('https://res.cloudinary.com/deg48jhcz/video/upload/v1780290518/a9vzcqfge5xcvm4dpkws.mp4')).toBe(true);
  ...
  it('should reject image URLs', () => {
    expect(isVideoUrl('https://res.cloudinary.com/deg48jhcz/image/upload/v1780290518/a9vzcqfge5xcvm4dpkws.jpg')).toBe(false);
