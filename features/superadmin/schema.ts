...
const checkoutOptionDefinitionSchema = z
  .object({
    id: z
      ...
      .min(1)
      .max(50)
      .regex(/^[a-z0-9_]+$/, "Option ID must be lowercase letters, numbers, and underscores."),
...
export const updateCheckoutOptionsCatalogSchema = z.object({
  options: z
    .array(checkoutOptionDefinitionSchema)
    .min(1, "At least one checkout option is required."),
});
...
export const createPricingPlanSchema = z.object({
  ...
  description: z
    ...
    .nullable(),
  features: z
    .array(z.string().max(150, "Each feature cannot exceed 150 characters.").trim())
