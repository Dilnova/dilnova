...
export default function PricingTab({ pricingPlans }: PricingTabProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {isPricingModalOpen && (
        <AccessibleModal isOpen={true} onClose={() => setIsPricingModalOpen(false)} backdropClassName="bg-black/60 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4" className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-t-3xl sm:rounded-3xl p-5 sm:p-6 w-full sm:max-w-md shadow-2xl max-h-[90vh] overflow-y-auto safe-area-bottom animate-[mobileMenuSlideDown_0.2s_ease-out]">
