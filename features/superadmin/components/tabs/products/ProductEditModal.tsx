...
export function ProductEditModal({
  ...
  const [editProdType, setEditProdType] = useState<"product" | "service">(
    product.type as "product" | "service",
  );
...
=======
      logger.error("Media upload error in ProductEditModal", err);
>>>>>>> 03275f0c05322a4383da3e33eb513d23e005b7e6
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-[10px] text-zinc-400 font-mono">
              {editProdMedia.length}/{maxMediaLimit} utilized
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {editProdMedia.map((m, idx) => (
              <div
                key={idx}
                className="relative aspect-square rounded-xl overflow-hidden bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 group"
              >
                {m.type === "video" ? (
