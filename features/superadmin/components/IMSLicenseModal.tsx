      ...
      <form onSubmit={handleSaveLicense} className="p-5 space-y-4">
        <div className="flex items-center justify-between">
          <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">
            Enable Inventory Management (IMS)
          </span>
          <input
            type="checkbox"
        ...
        <div className="space-y-1.5">
          <label className="block text-xs font-semibold text-zinc-600 dark:text-zinc-400">
            License Expiration Date (leave empty for lifetime access)
          </label>
          <input
            type="date"
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">
            Unlock Multi-Branch stock tracking (Tier 2)
          </span>
          <input
            type="checkbox"
        ...
        <div className="flex items-center justify-between">
          <span className="text-xs font-semibold text-zinc-700 dark:text-zinc-300">
            Unlock POS Billing Register & checkout (Tier 3)
          </span>
          <input
            type="checkbox"
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-[10px] text-zinc-400 font-mono">
            Default: 10 for all orgs (free tier). Increase for premium plans.
          </p>
          <input
            type="number"
            min={1}
