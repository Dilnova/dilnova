...
export default function SuperadminOrdersTab({
  simulatedOrders,
        ...
        <div className="space-y-3">
          {filteredOrders.map((order) => {
            ...
            return (
              <div
                key={order.id}
                className="bg-white border border-zinc-200 rounded-xl p-4 dark:bg-zinc-950 dark:border-zinc-800 shadow-sm"
              >
