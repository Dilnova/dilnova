    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          ...
          <div
            key={card.label}
            className="bg-white border border-zinc-200/80 rounded-xl p-4 dark:bg-zinc-950 dark:border-zinc-800 shadow-sm"
          >
            <div className="flex items-center justify-between mb-2">
              ...
              <span
                className={`w-8 h-8 rounded-xl ${card.bg} flex items-center justify-center text-base`}
              >
                {card.icon}
              </span>
            </div>
      ...
      {subTab === "suppliers" && <SuperadminSuppliersTab suppliers={suppliers} />}
      ...
      {subTab === "audit" && <SuperadminAuditTab movements={movements} />}
    </div>
  );
}
