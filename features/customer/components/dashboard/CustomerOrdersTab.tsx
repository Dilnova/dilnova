                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span
                          className={`text-[9px] font-mono font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${statusColor}`}
                        >
                    ...
                    <div className="divide-y divide-zinc-100 dark:divide-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl bg-white dark:bg-zinc-950 overflow-hidden">
                      {items.map((item: any) => {
                        ...
                        return (
                          <div
                            key={item.id}
                            className="flex items-center justify-between p-3.5 text-xs text-zinc-800 dark:text-zinc-200"
                          >
